      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => router.push("/")}>
            <div className="w-10 h-10 rounded-xl bg-teal-600 flex items-center justify-center shadow-md shadow-teal-100">
              <Activity className="w-6 h-6 text-white" />
            </div>
            <div>
              <span className="font-bold text-lg text-slate-800 tracking-tight">MediQueue</span>
              <span className="text-xs block text-teal-600 font-semibold -mt-1">Smart Hospital Waiting</span>
            </div>
          </div>
      ...
      <main className="flex-grow max-w-6xl mx-auto px-4 w-full py-12 flex flex-col gap-16">
        ...
        <div className="grid md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-7 flex flex-col gap-6 text-left">
            ...
            <p className="text-lg text-slate-600 max-w-lg leading-relaxed">
              MediQueue tracks your doctor's queue live. Receive free email alerts, see estimated waiting ranges, and only arrive when the doctor is ready for you.
            </p>
          ...
          <div className="md:col-span-5">
            <div className="bg-white border border-slate-200 shadow-xl rounded-2xl p-6 md:p-8 flex flex-col gap-6 animate-slide-in">
              <div>
                <h2 className="text-xl font-bold text-slate-900">Track Your Position</h2>
                <p className="text-sm text-slate-500 mt-1">Enter the 6-character code printed on your receipt or sent in your email.</p>
              </div>
        ...
        <div className="flex flex-col gap-8">
          <div className="text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight">How MediQueue Simplifies Waiting</h2>
            <p className="text-slate-500 mt-2">A clean clinical system optimized for maximum comfort and speed.</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white border border-slate-100 p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-bold text-slate-800 text-base">Check-In & Get Code</h3>
              <p className="text-slate-500 text-sm mt-2">
                Register online or at a hospital self-kiosk. Instantly receive a unique 6-character receipt token like <strong>A7F2K9</strong> and a printable QR code.
              </p>
            </div>
            ...
            <div className="bg-white border border-slate-100 p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-bold text-slate-800 text-base">Track Status Live</h3>
              <p className="text-slate-500 text-sm mt-2">
                Scan your QR code or type your token. Watch your exact live position shift in real-time as the doctor sees previous patients.
              </p>
            </div>
            ...
            <div className="bg-white border border-slate-100 p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-bold text-slate-800 text-base">Get Smart Alerts</h3>
              <p className="text-slate-500 text-sm mt-2">
                Subscribe to free email notifications. You'll get an alert directly in your inbox when there are only <strong>2 patients ahead</strong>.
              </p>
            </div>
            ...
            <div className="bg-white border border-slate-100 p-6 rounded-2xl shadow-sm hover:shadow-md transition">
              ...
              <h3 className="font-bold text-slate-800 text-base">Arrive Just in Time</h3>
              <p className="text-slate-500 text-sm mt-2">
                Walk into the department room exactly when called. No wasted hours in stuffy waiting halls, no risk of missing your number.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-teal-600 to-emerald-700 text-white rounded-3xl p-8 md:p-12 shadow-xl shadow-teal-900/10 grid md:grid-cols-3 gap-8 text-center md:text-left items-center">
          <div className="md:col-span-2 flex flex-col gap-3">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight">Improving Public Hospital Efficiency</h2>
            <p className="text-teal-50/90 leading-relaxed max-w-xl">
              MediQueue is designed to reduce crowd density inside clinics by up to 70%, promoting safe social distancing, patient comfort, and seamless operations for staff.
            </p>
          </div>
          <div className="flex flex-col gap-6 bg-white/10 backdrop-blur-sm p-6 rounded-2xl border border-white/10 text-center">
            ...
            <div className="text-xs text-teal-100 uppercase tracking-widest font-bold -mt-3">Average Wait Saved</div>
            <div className="w-full border-t border-white/10 my-1" />
            <div className="text-4xl font-extrabold text-white">94%</div>
            <div className="text-xs text-teal-100 uppercase tracking-widest font-bold -mt-3">Patient Satisfaction</div>
          </div>
        </div>
      </main>
      ...
      <footer className="bg-white border-t border-slate-200 py-8">
        <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-sm text-slate-800">MediQueue System</span>
          </div>
          <p className="text-xs text-slate-500">© 2026 MediQueue Inc. Designed for optimized outpatient departments.</p>
